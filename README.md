...
1. search for "kmp" and replace with the name you'll use for your workspace
...
<https://github.com/ArchangelX360/kotlin_multiplatform_dependencies/releases>
...
1. Replace `url = "https://github.com/ArchangelX360/kotlin_multiplatform_dependencies/releases/download/v0.1.0/rules_mylang-v0.1.0.tar.gz"` with a GitHub-provided source archive like `url = "https://github.com/ArchangelX360/kotlin_multiplatform_dependencies/archive/abc123.tar.gz"`
